...
HD_PWD='E:/Repository/MyIPcoreLib/FPGA-IPcore-Library/HDMI_tx_v1/HDMI_tx_v1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_TX.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HDMI_TX.tcl -notrace
