...
HD_PWD='E:/Repository/MyIPcoreLib/FPGA-IPcore-Library/HDMI_tx_v1/HDMI_tx_v1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_TX.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_TX.tcl
