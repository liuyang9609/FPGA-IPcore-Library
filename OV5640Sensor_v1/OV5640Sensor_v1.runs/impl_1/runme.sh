...
HD_PWD='E:/Repository/MyIPcoreLib/FPGA-IPcore-Library/OV5640Sensor_v1/OV5640Sensor_v1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OV5640_Sensor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OV5640_Sensor.tcl -notrace
