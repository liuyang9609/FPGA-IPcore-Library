...
HD_PWD='E:/Repository/MyIPcoreLib/FPGA-IPcore-Library/OV5640Sensor_v1/OV5640Sensor_v1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OV5640_Sensor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OV5640_Sensor.tcl
